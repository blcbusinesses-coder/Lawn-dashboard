...
export const metadata: Metadata = {
  ...
  description:
    'Professional lawn mowing, trimming, and yard cleanup in Kendallville and across Noble County, Indiana. Enter your address and get your exact price in under a minute. New customers get 25% off their first month.',
